  ...
  internal = rec {
    ...
    crates = {
      ...
      "lint" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tests/lint; };
        libPath = "lib.rs";
        dependencies = [
          {
      ...
      "macrotest" = rec {
        ...
        src = pkgs.fetchgit {
          url = "https://github.com/taiki-e/macrotest.git";
          rev = "07ad470b0c8aa315c808adb692ed8292b5bf89e8";
          sha256 = "023m7s04mhv6gs6bl9ryq5l9yyvjy5di47lczwrz8mj4j6s2f60d";
        };
        authors = [
      ...
      "no-core" = rec {
        ...
        version = "0.0.1";
        edition = "2018";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tests/no-core; };
        libName = "no_core";
        libPath = "lib.rs";
        dependencies = [
          {
      ...
      "prettyplease" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/taiki-e/prettyplease.git";
          rev = "cd08a29d5e6b6c10784c08caca2361a31f992a3a";
          sha256 = "18mhlq4143a0rad4m318c7163qjq5v2bzqzkc1p836l9i3396vcq";
        };
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "proc-macro2" = rec {
        ...
        version = "1.0.65";
        edition = "2018";
        sha256 = "1zhxdbfn0g2q5wqzd4xcbglrgyr9yzwcjy8w4sqpia3h8q8jbplj";
        libName = "proc_macro2";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
      ...
      "quote" = rec {
        ...
        version = "1.0.30";
        edition = "2018";
        sha256 = "1fw4h7j524dq7dk1fciahzkhx9ngjxy6w3qp2n5ll9bpqavs21sr";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "trybuild" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "https://github.com/taiki-e/trybuild.git";
          rev = "8a5237268c040ae90525bdd1559c5d0c29cad51d";
          sha256 = "1y0cskbr1l7433cn8mjg6fqyczn6khi8grh6h3fhz3a7nkxmp3pp";
        };
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
